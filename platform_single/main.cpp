...
public:
	...
	addr_t dwt1_start_addr = 0x73000000;
	addr_t dwt1_size = 0x00100000;
	addr_t dwt1_end_addr = dwt1_start_addr + dwt1_size - 1;

	addr_t dwt2_start_addr = 0x73100000;
	addr_t dwt2_size = 0x00100000;
	addr_t dwt2_end_addr = dwt2_start_addr + dwt2_size - 1;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > dwt2_end_addr) &&
...
int sc_main(int argc, char **argv) {
	...
	bus.ports[12] = new PortMapping(opt.dwt1_start_addr, opt.dwt1_end_addr);
	bus.ports[13] = new PortMapping(opt.dwt2_start_addr, opt.dwt2_end_addr);
	...
	bus.isocks[12].bind(dwt1.tsock);
	bus.isocks[13].bind(dwt2.tsock);
