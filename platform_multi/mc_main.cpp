...
public:
	...
	addr_t dwt1_core0_start_addr = 0x73000000;
	addr_t dwt1_core0_size = 0x00100000;
	addr_t dwt1_core0_end_addr = dwt1_core0_start_addr + dwt1_core0_size - 1;

	addr_t dwt1_core1_start_addr = 0x73100000;
	addr_t dwt1_core1_size = 0x00100000;
	addr_t dwt1_core1_end_addr = dwt1_core1_start_addr + dwt1_core1_size - 1;

	addr_t dwt2_core0_start_addr = 0x73200000;
	addr_t dwt2_core0_size = 0x00100000;
	addr_t dwt2_core0_end_addr = dwt2_core0_start_addr + dwt2_core0_size - 1;
	
	addr_t dwt2_core1_start_addr = 0x73300000;
	addr_t dwt2_core1_size = 0x00100000;
	addr_t dwt2_core1_end_addr = dwt2_core1_start_addr + dwt2_core1_size - 1;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > dwt2_core1_end_addr) &&
...
int sc_main(int argc, char **argv) {
	...
	DWT_1 dwt1_core0("dwt1_core0");
	DWT_1 dwt1_core1("dwt1_core1");
	DWT_2 dwt2_core0("dwt2_core0");
	DWT_2 dwt2_core1("dwt2_core1");
	...
	bus.ports[12] = new PortMapping(opt.dwt1_core0_start_addr, opt.dwt1_core0_end_addr);
	bus.ports[13] = new PortMapping(opt.dwt1_core1_start_addr, opt.dwt1_core1_end_addr);
	bus.ports[14] = new PortMapping(opt.dwt2_core0_start_addr, opt.dwt2_core0_end_addr);
	bus.ports[15] = new PortMapping(opt.dwt2_core1_start_addr, opt.dwt2_core1_end_addr);
	...
	bus.isocks[12].bind(dwt1_core0.tsock);
	bus.isocks[13].bind(dwt1_core1.tsock);
	bus.isocks[14].bind(dwt2_core0.tsock);
	bus.isocks[15].bind(dwt2_core1.tsock);
